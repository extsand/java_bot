...
locals {
	...
	app_count = 1
	image_tag = "init"
	# APP_LOADBALANCER_LINK
	# APP_BOT_USERNAME
	# APP_BOT_TOKEN

	#FIX THIS!!!!!===========================
	build_app_command = "make build-app APP_NAME=${local.app_name} ENV_NAME=${local.env} APP_TAG=${local.image_tag}  APP_LOADBALANCER_LINK=${} APP_BOT_USERNAME=${} APP_BOT_TOKEN=${}"
	...
	#project tags
	project_tags = {
		"project" = "DevOps Academy JavaBot"
		"owner" = "extsand"
	}
